...
function fileReader(csvFilePath){
  var content = fs.readFileSync(csvFilePath, "utf8");
  return csvjson.toObject(content, ',');
}
...
function parser(arr){
  arr.forEach(function(a){
    a.originalInvestment = parseInt(a.originalInvestment);
    a.valueToday = parseInt(a.valueToday);
  });
