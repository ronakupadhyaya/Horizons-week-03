...
function fileReader(csvFilePath){
  // YOUR CODE HERE
  var file = fs.readFileSync(csvFilePath, "utf8");
...
function parser(arr){
  ...
  arr.forEach(function(investmentObject) {
    investmentObject.originalInvestment = parseInt(investmentObject.originalInvestment);
    investmentObject.valueToday = parseInt(investmentObject.valueToday);
  });
  return arr;
}
