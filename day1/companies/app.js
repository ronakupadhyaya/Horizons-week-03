...
function fileReader(csvFilePath){
  ...
  var info = csvjson.toObject(data);
  return info;
}
...
function parser(arr){
  arr.forEach(function(obj){
    var strnum = obj['originalInvestment'];
    var strval = obj['valueToday'];
    obj.originalInvestment = parseInt(strnum);
    obj.valueToday = parseInt(strval);
  })
  return arr;
}
