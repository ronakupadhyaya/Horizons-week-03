...
function fileReader(csvFilePath){
  // YOUR CODE HERE
return csvjson.toObject(fs.readFileSync(csvFilePath).toString(),  { encoding : 'utf8'});
...
function parser(arr){
  // YOUR CODE HERE
var parseArr = arr.map(function(object) {
  object.valueToday = parseInt(object.valueToday);
  object.originalInvestment = parseInt(object.originalInvestment);
  return object;
})
return parseArr;
}
