...
function showTasks(){
  ...
  if(program.id){
    ...
    //console.log(index);
  //  console.log(program.id,index,data[index].priority,data[index].name);
    var result=`Task #${program.id} Priority ${data[index].priority}: ${data[index].name}`
    console.log(result);
  }
  else{
    data.forEach(function(item,index){
      //console.log(program.id,index,data[index].priority,data[index].name);
      var result=`Task #${index+1} Priority ${data[index].priority}: ${data[index].name}`
      console.log(result);
    }
  )}
}
