  ...
  program
    .option('-p, --priority <n>', 'Prioritize task', parseInt);
  ...
  function showTasks(){
    ...
    else if(parseInt(input[1]) > data.length){
      console.log('Error: input number exceed list');
    }
    else{
      num = parseInt(input[1]) - 1;
      console.log("Task #" + parseInt(input[1]) + " Priority " + data[num].priority +": " + data[num].name)
  }
  }
