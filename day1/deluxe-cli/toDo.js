...
.option('-p, --priority <n>', 'Specify id of priority', parseInt)
...
function showTasks(){
  ...
  // if we find an i, we'll know where to go in data

  if(flagsPresent.includes('-i')){
    console.log("Task #" + args[4] + " Priority " + data[args[4]-1].priority + ": " + data[args[4]-1].name);
  }
