...
function showTasks(){
  // YOUR CODE HERE
    // var r = "Task #" + id + " Priority " + data[id-1].priority + ": " + data[id-1].name + '\t';
    // result += r;
  if (program.id) {
    ...
    for (var i = 0; i < data.length; i++) {
      var j = i+1;
      console.log("Task #" + j + " Priority " + data[i].priority + ": " + data[i].name);
    }
  }
}
