...
program
  .option('-p, --priority <n>', 'Specify priority of a task', parseInt);

program
  .option('-c, --completed', 'Specify the completion of a task');
...
function showTasks(){
  // YOUR CODE HERE
  var ifCompleted = program.completed;
  var id = program.id || 0;
  if(ifCompleted){
...
//another function to toggle completed
