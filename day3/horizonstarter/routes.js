...
router.get('/project/:projectid', function(req, res) {
  //required and result
  Project.findbyID(req.params.projectid,function(err,found){// params at req.params.projectid because /:projectid is a variable
    console.log(req.params.projectid);
  if(err){
    console.log('cloud error')
  }else{
    res.render('project',{
      found:found // first found is in the handle bar. 2nd found is found from   Project.findbyID(req.params.projectid,function(err,found, which is the data
// this is to assign found to found
    }
  }
  })
