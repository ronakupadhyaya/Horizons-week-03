...
// YOUR CODE HERE
program
  .option('-t, --task <t>', 'Specify a task name to be completed')
// Arguments
...
function showTasks() {
  ...
  if (program.task) {
    ToDoItem.find({
      ...
      task.forEach(function(temp) {
        console.log('Task:', temp.name + ', Priority:', temp.priority + ', Completed:', temp.completed);
      })
    })
  } else {
